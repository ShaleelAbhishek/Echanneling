...
import { ViewAllAppointmentsComponent } from 'src/app/modules/view-all-appointments/view-all-appointments.component';
import { ViewAllPatientsComponent } from 'src/app/modules/view-all-patients/view-all-patients.component';
